...
const SocialIcons = ({variant, pinterestInnerColor = 'white', ...otherProps}) => {
    ...
    return (
        ...
        >
            ...
            {[
                {
                    href: 'https://www.youtube.com/user/RoyalCyberSolutions/videos',
                    icon: SocialYoutubeIcon,
                    ariaLabel: 'YouTube'
                },
                {
                    href: 'https://www.instagram.com/royalcyberinc/',
                ...
                {
                    href: 'https://x.com/RoyalCyberUSA',
                    icon: SocialTwitterIcon,
                    ariaLabel: 'Twitter'
                },
                {
                    href: 'https://www.facebook.com/RoyalCyber',
